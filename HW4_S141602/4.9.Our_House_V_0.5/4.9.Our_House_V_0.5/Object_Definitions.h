...
Material_Parameters material_static[N_MAX_STATIC_OBJECTS+2];

void compute_AABB(Object *obj_ptr) {
	// Do it yourself.
}
int only_for_geom_func;
...
void set_material_static(void) {
	// assume ShaderProgram_PS is used
	glUniform4fv(loc_material.ambient_color, 1, material_static[only_for_geom_func].ambient_color);
	glUniform4fv(loc_material.diffuse_color, 1, material_static[only_for_geom_func].diffuse_color);
	glUniform4fv(loc_material.specular_color, 1, material_static[only_for_geom_func].specular_color);
	glUniform1f(loc_material.specular_exponent, material_static[only_for_geom_func].specular_exponent);
	glUniform4fv(loc_material.emissive_color, 1, material_static[only_for_geom_func].emissive_color);
}
...
void define_static_objects(void) {
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.135f;
	material_static[only_for_geom_func].ambient_color[1] = 0.2225f;
	material_static[only_for_geom_func].ambient_color[2] = 0.1575f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.54f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.89f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.63f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.316228f;
	material_static[only_for_geom_func].specular_color[1] = 0.316228f;
	material_static[only_for_geom_func].specular_color[2] = 0.316228f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 12.5f;

	material_static[only_for_geom_func].emissive_color[0] = 0.0f;
	material_static[only_for_geom_func].emissive_color[1] = 0.0f;
	material_static[only_for_geom_func].emissive_color[2] = 0.0f;
	material_static[only_for_geom_func].emissive_color[3] = 1.0f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.0f;
	material_static[only_for_geom_func].ambient_color[1] = 0.0f;
	material_static[only_for_geom_func].ambient_color[2] = 0.0f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.4f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.6f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.3f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.5f;
	material_static[only_for_geom_func].specular_color[1] = 0.5f;
	material_static[only_for_geom_func].specular_color[2] = 0.5f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 32.0f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.24725f;
	material_static[only_for_geom_func].ambient_color[1] = 0.1995f;
	material_static[only_for_geom_func].ambient_color[2] = 0.0745f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.75164f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.60648f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.22648f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.628281f;
	material_static[only_for_geom_func].specular_color[1] = 0.555802f;
	material_static[only_for_geom_func].specular_color[2] = 0.366065f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 128.0f*0.4f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.1745f;
	material_static[only_for_geom_func].ambient_color[1] = 0.01175f;
	material_static[only_for_geom_func].ambient_color[2] = 0.01175f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.61424f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.04136f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.04136f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.727811f;
	material_static[only_for_geom_func].specular_color[1] = 0.626959f;
	material_static[only_for_geom_func].specular_color[2] = 0.626959f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 128.0f*0.6;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.05f;
	material_static[only_for_geom_func].ambient_color[1] = 0.05f;
	material_static[only_for_geom_func].ambient_color[2] = 0.0f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.5f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.5f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.4f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.7f;
	material_static[only_for_geom_func].specular_color[1] = 0.7f;
	material_static[only_for_geom_func].specular_color[2] = 0.04f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 128.0f*0.078125f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.19125f;
	material_static[only_for_geom_func].ambient_color[1] = 0.05f;
	material_static[only_for_geom_func].ambient_color[2] = 0.0f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.7038f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.27048f;
	material_static[only_for_geom_func].diffuse_color[2] =  0.0828f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.256777f;
	material_static[only_for_geom_func].specular_color[1] = 0.137622f;
	material_static[only_for_geom_func].specular_color[2] = 0.086014f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 128.0f*0.1f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.77f;
	material_static[only_for_geom_func].ambient_color[1] = 0.77f;
	material_static[only_for_geom_func].ambient_color[2] = 0.77f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.25f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.25f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.25f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.4f;
	material_static[only_for_geom_func].specular_color[1] = 0.4f;
	material_static[only_for_geom_func].specular_color[2] = 0.4f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;
	...
	material_static[only_for_geom_func].specular_color[0] = 0.04f;
	material_static[only_for_geom_func].specular_color[1] = 0.7f;
	material_static[only_for_geom_func].specular_color[2] = 0.04f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 2.5f;
	...
	static_objects[OBJ_IRONMAN].front_face_mode = GL_CW;
	...
	static_objects[OBJ_IRONMAN].ModelMatrix[0] = glm::translate(glm::mat4(1.0f), glm::vec3(66.0f, 50.0f, 25.0f));
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.05f;
	material_static[only_for_geom_func].ambient_color[1] = 0.02f;
	material_static[only_for_geom_func].ambient_color[2] = 0.02f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.8f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.1f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.4f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.74f;
	material_static[only_for_geom_func].specular_color[1] = 0.3f;
	material_static[only_for_geom_func].specular_color[2] = 0.04f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.329412f;
	material_static[only_for_geom_func].ambient_color[1] = 0.223529f;
	material_static[only_for_geom_func].ambient_color[2] = 0.027451f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.6f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.3f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.0f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.992157f;
	material_static[only_for_geom_func].specular_color[1] = 0.941176f;
	material_static[only_for_geom_func].specular_color[2] = 0.807843f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 0.21794872f*0.6f;
	...
	material_static[only_for_geom_func].diffuse_color[0] = 0.2f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.3f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.8f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.992157;
	material_static[only_for_geom_func].specular_color[1] = 0.941176f;
	material_static[only_for_geom_func].specular_color[2] = 0.807843f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;
	...
	static_objects[OBJ_TANK].front_face_mode = GL_CW;
	only_for_geom_func = 11;
	prepare_geom_of_static_object(&(static_objects[OBJ_TANK]));
	material_static[only_for_geom_func].ambient_color[0] = 0.0215f;
	material_static[only_for_geom_func].ambient_color[1] = 0.1745f;
	material_static[only_for_geom_func].ambient_color[2] = 0.0215f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.1f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.74f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.2f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.633f;
	material_static[only_for_geom_func].specular_color[1] = 0.727811f;
	material_static[only_for_geom_func].specular_color[2] = 0.633f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_exponent = 76.8f;
	...
	static_objects[OBJ_TANK].ModelMatrix[0] = glm::translate(glm::mat4(1.0f), glm::vec3(83.0f, 50.0f, 0.0f));
	...
	material_static[only_for_geom_func].ambient_color[0] = 0.3f;
	material_static[only_for_geom_func].ambient_color[1] = 0.2f;
	material_static[only_for_geom_func].ambient_color[2] = 0.02f;
	material_static[only_for_geom_func].ambient_color[3] = 1.0f;

	material_static[only_for_geom_func].diffuse_color[0] = 0.77f;
	material_static[only_for_geom_func].diffuse_color[1] = 0.55f;
	material_static[only_for_geom_func].diffuse_color[2] = 0.0f;
	material_static[only_for_geom_func].diffuse_color[3] = 1.0f;

	material_static[only_for_geom_func].specular_color[0] = 0.9f;
	material_static[only_for_geom_func].specular_color[1] = 0.94f;
	material_static[only_for_geom_func].specular_color[2] = 0.8f;
	material_static[only_for_geom_func].specular_color[3] = 1.0f;
...
Material_Parameters material_car;
void prepare_geom_obj(int geom_obj_ID, char *filename, GEOM_OBJ_TYPE geom_obj_type) {
	...
	material_car.ambient_color[0] = 0.24725f;
	material_car.ambient_color[1] = 0.1995f;
	material_car.ambient_color[2] = 0.0745f;
	material_car.ambient_color[3] = 1.0f;

	material_car.diffuse_color[0] = 0.35164f;
	material_car.diffuse_color[1] = 0.30648f;
	material_car.diffuse_color[2] = 0.32648f;
	material_car.diffuse_color[3] = 1.0f;

	material_car.specular_color[0] = 0.328281f;
	material_car.specular_color[1] = 0.355802f;
	material_car.specular_color[2] = 0.466065f;
	material_car.specular_color[3] = 1.0f;

	material_car.specular_exponent = 31.2f;

	material_car.emissive_color[0] = 0.1f;
	material_car.emissive_color[1] = 0.1f;
	material_car.emissive_color[2] = 0.0f;
	material_car.emissive_color[3] = 1.0f;
